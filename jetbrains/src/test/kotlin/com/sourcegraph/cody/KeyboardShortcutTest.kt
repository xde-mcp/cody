...
import com.sourcegraph.cody.chat.actions.ExplainCodeAction
import com.sourcegraph.cody.chat.actions.SmellCodeAction
import com.sourcegraph.cody.chat.actions.UnitTestAction
  ...
  companion object {
    ...
    private val keysToActionIds =
        mapOf(
            ...
            ExplainCodeAction.ID to arrayOf("ctrl alt 1", "ctrl alt 1"),
            SmellCodeAction.ID to arrayOf("ctrl alt 2", "ctrl alt 2"),

            // This command also handles cody.inlineEditRetryAction:
            EditCodeAction.ID to arrayOf("alt K", "ctrl alt ENTER"),
            DocumentCodeAction.ID to arrayOf("alt H", "ctrl alt H"),
            UnitTestAction.ID to arrayOf("alt G", "ctrl alt G"),
